...
function registro() {
    ...
    /*    useEffect(() => {
           obtenerTiposDeDocumento().then((dato) => {
               console.log("entrooo")
               console.log(dato)
               const opciones = dato.filter((data) => data.id) // opcional: solo activos
                   .map((data) => ({
                       label: data.id,
                       value: data.id, 
                   }));
               ...
               console.log("sapoo hp")
               console.log(tipos)
           });
       }, []); */ const [tipos, setTipos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // ← nombres alineados
        ...
        "registro.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$frontend$2f$tipo_documentoSevices$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["obtenerTiposDeDocumento"])().then({
                "registro.useEffect": (dato)=>{
                    ...
                    setTipos(opciones); // ← ahora sí, todo cuadra
                }
            }["registro.useEffect"]);
        }
    }["registro.useEffect"], []);
...
_s(registro, "bgrj5Q6U6H7VIlPwo5UqX9MF6rQ=", false, function() {
    return [
...
//# sourceMappingURL=src_3428288e._.js.map